...
int main(void)
{
    ...
    std::map<std::string, std::string>   ft1;
    ft1.insert( std::make_pair("Baie de Goji", "Rouge") );
    ft1.insert( std::make_pair("Baie de Goji", "Rouge") );
    ft1["Banane"] = "Orange";
    ft1["Banane"] = "Jaune";
    
    std::cout << colors::bold << colors::bright_blue << "[ ft1 ]" << std::endl << colors::reset << "Map contents: " << std::endl;
    for (std::map<std::string, std::string>::iterator it = ft1.begin(); it != ft1.end(); it++) {
    ...
    std::map<std::string, std::string>::iterator it = ft1.find("Banane");
    ...
    std::map<std::string, std::string>   ft2( ft1.begin(), ft1.end() );
    std::cout << colors::bold << colors::bright_blue << "[ ft2 - ctor(it1, it2) test ]" << std::endl << colors::reset << "Map contents: " << std::endl;    
    for (std::map<std::string, std::string>::iterator it = ft2.begin(); it != ft2.end(); it++) {
        std::cout << std::setw(15);
        std::cout << it->first;
        std::cout << " -> " << it->second << std::endl;
    }
    ft2.insert( std::make_pair("Ananas", "Jaune") );
    std::cout << std::endl;

    std::map<std::string, std::string>   ft3( ft2 );
    std::cout << colors::bold << colors::bright_blue << "[ ft3 - ctor( map ) test ]" << std::endl << colors::reset << "Map contents: " << std::endl;    
    for (std::map<std::string, std::string>::iterator it = ft3.begin(); it != ft3.end(); it++) {
        std::cout << std::setw(15);
        std::cout << it->first;
        std::cout << " -> " << it->second << std::endl;
    }
    ...
    std::map<std::string, std::string>   ft4 = ft3;
    std::cout << colors::bold << colors::bright_blue << "[ ft4 - ctor( operator= ) test ]" << std::endl << colors::reset << "Map contents: " << std::endl;
    for (std::map<std::string, std::string>::iterator it = ft4.begin(); it != ft4.end(); it++) {
        std::cout << std::setw(15);
        std::cout << it->first;
        std::cout << " -> " << it->second << std::endl;
    }
    ...
    std::cout << "Printing all nodes using iterators ( [KEY] -> [VALUE] ) : " << std::endl << std::endl;
    for (std::map<std::string, std::string>::const_iterator it = ft4.begin(); it != ft4.end(); it++) {
        std::cout << std::setw(15);
        std::cout << it->first;
        std::cout << " -> " << it->second << std::endl;
    }
    ...
    std::cout << "Printing all nodes using iterators ( [KEY] -> [VALUE] ) : " << std::endl << std::endl;
    for (std::map<std::string, std::string>::reverse_iterator it = ft4.rbegin(); it != ft4.rend(); it++) {
        std::cout << std::setw(15);
        std::cout << it->first;
        std::cout << " -> " << it->second << std::endl;
    }
    ...
    std::cout << "Printing all nodes using iterators ( [KEY] -> [VALUE] ) : " << std::endl << std::endl;
    for (std::map<std::string, std::string>::const_reverse_iterator it = ft4.rbegin(); it != ft4.rend(); it++) {
        std::cout << std::setw(15);
        std::cout << it->first;
        std::cout << " -> " << it->second << std::endl;
    }
    ...
    std::map<std::string, std::string>   ft5;
        for (std::map<std::string, std::string>::iterator it = ft5.begin(); it != ft5.end(); it++) {
        std::cout << std::setw(15);
        std::cout << it->first;
        std::cout << " -> " << it->second << std::endl;
    }
    ...
    ft4.insert( std::make_pair("Myrtille", "Bleu") );
    ft4.insert( std::make_pair("Prune", "Violet") );
    ft4.insert( std::make_pair("Papaye", "Orange") );
    ...
    std::map<std::string, std::string>   ft6;
    ft6["Nefle"] = "Marron";
    ft6["Palmier peche"] = "Rouge";
    ft6["Pasteque"] = "Rouge";
    std::cout << "Printing ft6 contents:" << std::endl;
    for (std::map<std::string, std::string>::iterator it = ft6.begin(); it != ft6.end(); it++) {
        std::cout << std::setw(14);
        std::cout << it->first;
        std::cout << " -> " << it->second << std::endl;
    }
    ...
    std::map<std::string, std::string>::iterator hint = ft6.begin();
    for (int i = 0; i < 5; i++)
        hint++;
    std::cout << "hint: " << hint->first << " -> " << hint->second << std::endl;
    std::map<std::string, std::string>::iterator it_nefle = ft4.insert(hint, std::make_pair("Nefle", "Marron"));
    ...
    std::map<std::string, std::string>::iterator erase_it = ft4.begin();
    for (int i = 0; i < 3; i++)
        erase_it++;    
    ...
    std::map<char, int>              ft7;
    std::map<char, int>::iterator    it_erase;
    std::map<char, int>::iterator    it_erase2;
    ...
    for (std::map<char, int>::iterator it = ft7.begin(); it != ft7.end(); it++) {
        std::cout << std::setw(14);
        std::cout << it->first;
        std::cout << " -> " << it->second << std::endl;
    }
    ...
    std::map<std::string, std::string>   fbPlayerHeights;
    std::map<std::string, std::string>   fbPlayerWeights;
    fbPlayerHeights.insert( std::make_pair("Van Dijk", "1m93") );
    fbPlayerHeights.insert( std::make_pair("Salah", "1m75") );
    fbPlayerHeights.insert( std::make_pair("Mane", "1m75") );
    fbPlayerHeights.insert( std::make_pair("Firmino", "1m80") );

    fbPlayerWeights.insert( std::make_pair("Nunez", "78 kg") );
    fbPlayerWeights.insert( std::make_pair("Keita", "63 kg") );
    fbPlayerWeights.insert( std::make_pair("Robertson", "63 kg") );
    fbPlayerWeights.insert( std::make_pair("Alisson", "91 kg") );

    std::cout << "fbPlayerHeights: " << std::endl;
    for (std::map<std::string, std::string>::iterator it = fbPlayerHeights.begin(); it != fbPlayerHeights.end(); it++) {
        std::cout << std::setw(14);
        std::cout << it->first;
        std::cout << " -> " << it->second << std::endl;
    }
    ...
    for (std::map<std::string, std::string>::iterator it = fbPlayerWeights.begin(); it != fbPlayerWeights.end(); it++) {
        std::cout << std::setw(14);
        std::cout << it->first;
        std::cout << " -> " << it->second << std::endl;
    }
    ...
    std::map<std::string, std::string>::iterator f1 = ft4.find("Peche");
    std::map<std::string, std::string>::iterator f2 = ft4.find("Banane");
    std::map<char, int>::iterator                f3 = ft7.find('a');
    ...
    std::map<std::string, std::string>::const_iterator f5 = ft4.find("Peche");
    std::map<std::string, std::string>::const_iterator f6 = ft4.find("Banane");
    std::map<char, int>::const_iterator                f7 = ft7.find('a');
    ...
    std::pair< std::map<char, int>::const_iterator, std::map<char, int>::const_iterator >  ret2;
    ...
    for (std::map<char, int>::iterator it = eqrange.begin(); it != eqrange.end(); it++) {
        std::cout << std::setw(14);
        std::cout << it->first;
        std::cout << " -> " << it->second << std::endl;
    }
    ...
    for (std::map<char, int>::iterator it = eqrange2.begin(); it != eqrange2.end(); it++) {
        std::cout << std::setw(14);
        std::cout << it->first;
        std::cout << " -> " << it->second << std::endl;
    }
    std::cout << std::endl;
    std::map<char, int>::const_iterator    itlow2, itup2;
    ...
    for (std::map<char, int>::const_iterator it = itlow2; it != itup2; it++) {
        std::cout << std::setw(14);
        std::cout << it->first;
        std::cout << " -> " << it->second << std::endl;
    }
    ...
    for (int i = 0; i < 1000000; i++)
        perf.insert( std::make_pair(i, i) );
    std::cout << "2/ Searching for lowest value (0): ";
    std::map<int, int>::iterator    itp = perf.find(0);
    ...
    std::cout << "Tree size: " << m1.size() << std::endl;
    std::cout << "Max size: " << m1.max_size() << std::endl;
    
    for (std::map<int, int>::iterator it = m1.begin(); it != m1.end(); it++)
        std::cout << it->first << " -> " << it->second << std::endl;

    //for (std::map<int, int>::iterator it = m1.begin(); it != m1.end(); it++)
    for (int i = 25781; i < 781245; i++)
        m1.erase(i);
    std::cout << "Tree size: " << m1.size() << std::endl;
    ...
    m3.insert( std::make_pair("Charlie", 3.09) );
    m3.insert( std::make_pair("Zebbi", 4.00) );

    for (std::map<float, std::string>::iterator it = m.begin(); it != m.end(); it++)
        std::cout << it->first << " -> " << it->second << std::endl;
    for (std::map<std::string, float>::iterator it = m2.begin(); it != m2.end(); it++)
        std::cout << it->first << " -> " << it->second << std::endl;
    for (std::map<std::string, float>::iterator it = m3.begin(); it != m3.end(); it++)
        std::cout << it->first << " -> " << it->second << std::endl;*/
}