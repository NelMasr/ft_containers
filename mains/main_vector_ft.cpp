...
int main(void)
{
    ...
    for (ft::vector<int>::iterator it = ft1.begin(); it != ft1.end(); it++)
    {
        std::cout << std::setw(5);
        std::cout << *it << ' ';
    }
    ...
    ft::vector<int> ft2(7, 100);
    
    std::cout << "Printing ft2 contents" << std::endl;
    for (ft::vector<int>::iterator it = ft2.begin(); it != ft2.end(); it++)
    {
        std::cout << std::setw(5);
        std::cout << *it << ' ';
    }
    ...
    ft::vector<int>::iterator itt = ft3.end();
    
    std::cout << "Printing ft3 contents" << std::endl;
    for (ft::vector<int>::const_iterator it = ft3.begin(); it != itt; it++)
    {
        std::cout << std::setw(5);
        std::cout << *it << ' ';
    }
    ...
    for (ft::vector<int>::iterator it = ft4.begin(); it != ft4.end(); it++)
    {
        std::cout << std::setw(5);
        std::cout << *it << ' ';
    }
    ...
    for (ft::vector<int>::iterator it = ft5.begin(); it != ft5.end(); it++)
    {
        std::cout << std::setw(5);
        std::cout << *it << ' ';
    }
    ...
    ft6.push_back(78);
    ft::vector<int>::iterator   size_it = ft5.begin() + 5;
    ft::vector<int>::iterator   size_itt = ft5.end() - 3;
    ...
    for (ft::vector<std::string>::iterator it = ft7.begin(); it != ft7.end(); it++)
    {
        std::cout << std::setw(5);
        std::cout << *it << ' ';
    }
